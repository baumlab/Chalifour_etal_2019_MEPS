...
library(here)
b<- read.csv("data/beach.catch.csv") #aggregated data from all_clean.csv

#bchinhab

hab<- read.csv("data/site.char.marsh.csv") #habitat variables measured for all marsh sites
...
#Purse models
purse<- read.csv("data/purse.catch.csv") #aggregated data from all_clean.csv
...
p.hab<- read.csv("data/site.char.eelgrass.csv") #habitat variables measured for eelgrass (only used LAI) and sand flat sites 
...
############ Final plot with both marsh and eelgrass/sand flat covariates
