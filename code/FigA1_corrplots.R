...
library(corrplot)
##old-del part of code
#M<- cor(habcovar)
#corrplot(M)
#png("/Users/Lia/Documents/Git/Fraser-salmon/Ch1.Seasonal_diversity/expl.plots/chin.corr.marsh.png", width=15, height=10, units = "in", res=600, type="cairo")
...
A<- cor(habcovar_all)
corrplot(A, col=col4(100))
png("/Users/Lia/Documents/Git/Fraser-salmon/Ch1.Seasonal_diversity/expl.plots/corr.all.marsh.png", width=15, height=10, units = "in", res=1000, type="cairo")
corrplot.mixed(A, tl.col = "black", tl.cex = .8)
dev.off()
